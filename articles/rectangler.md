...
Annotations can be placed above, below, left, or right of rectangles.
The text can also be rotated when needed.
...
![](figures/vignette-annotation-basic-1.png)![](figures/vignette-annotation-basic-2.png)
